    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border"
        ...
        <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item" data-menu="dropdown"><a class="nav-link" href="/progress-patient-info"><i
                            class="feather icon-user"></i><span data-i18n="Personal Information">Personal
                            Information</span></a></li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="nav-link" href="#"><i
                            class=" feather icon-calendar"></i><span data-i18n="Schedule Appointment">Schedule
                            Appointment</span></a></li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="nav-link" href="#"><i
                            class=" feather icon-file-text"></i><span data-i18n="Laboratory Results">Laboratory Result
                            Status</span></a></li>
